...
export class Birb{
    ...
    draw(){
        if(this.color == "green"){
            ...
            this.birbElement1.setAttribute("src", "/images/duo_green_"+Math.min(4, Math.ceil(this.jumpAnimation))+".png");
            ...
            this.birbElement2.setAttribute("src", "/images/duo_blue_"+Math.min(4, Math.ceil(this.jumpAnimation))+".png");
