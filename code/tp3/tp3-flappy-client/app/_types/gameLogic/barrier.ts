...
export class ColorBarrier extends Barrier{
    ...
    constructor(){
        ...
        let r = Math.random();
        if(r < 0.5){
            this.shapes.push(new Shape(new Circle(r < 0.25 ? "blue" : "green", 250, 75, 75), null, null));
            this.height = 150;
        }
        else{
            this.shapes.push(new Shape(new Rectangle(r < 0.75 ? "blue" : "green", 100, 0, 300, 50), null, null));
            this.height = 50;
        }
        this.y -= this.height;
    }
