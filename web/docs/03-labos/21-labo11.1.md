...
📦 Un [projet serveur et un projet client](https://github.com/departement-info-cem/4W6-WebServices/releases/latest/download/code-labo11.1.zip) vous sont fournis. N'exécutez pas tout de suite le serveur, il y aura un modèle à ajouter, une migration à créer puis à exécuter plus tard.
...
<center>![Dossier pour les images](./_21-labo11.1/imageFolder.png)</center>
...
<center>![Liste d'ids](./_21-labo11.1/ids.png)</center>
...
<center>![Liste d'images](./_21-labo11.1/pictures.png)</center>
