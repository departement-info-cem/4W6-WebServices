...
<center>![Bannière décorative](./_22-labo11.2/banner.png)</center>

C'est le dernier laboratoire ! 😭 Téléchargez les [projets de départ](https://github.com/departement-info-cem/4W6-WebServices/releases/latest/download/code-labo11.2.zip) en séchant vos larmes 💦
...
L'objectif de cette section sera d'afficher les données de l'utilisateur côté Next.js. Comme le modèle `User` n'existe pas côté client et qu'on n'a pas accès à la base de données et aux rôles, il faudra être un peu créatif. (Mais pas beaucoup)

<center>![Profil de l'utilisateur](./_22-labo11.2/profile.png)</center>
...
<center>![Créer un review](./_22-labo11.2/studentOnly.png)</center>
...
<center>![Supprimer un review](./_22-labo11.2/authorOnly.png)</center>
