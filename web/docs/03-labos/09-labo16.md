...
Des [projets de départ](../../static/files/labo16.zip) Next.js et ASP.NET Core vous sont fournis. Orchestrez bien `npm install`, `npm run dev` et `dotnet ef database update`.
