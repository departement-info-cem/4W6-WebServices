...
<center>![Bannière](./_04-tp4/header.png)</center>

## 📥 Remise
* 📍 Où : sur **Git** uniquement (N'oubliez pas l'invitation [https://github.com/MaximePelletier15](https://github.com/MaximePelletier15))
* ⏰ Quand : **17 mai à 23h59**.
* ⛔ Attention, il y a une **remise partielle** à présenter avant le **7 mai à 17h59** pour la **partie C**.
...
Les [projets Next.js + ASP.NET Core](https://github.com/departement-info-cem/4W6-WebServices/releases/latest/download/code-tp4.zip) sont fournis pour ce TP.
...
<center>![Démo de PostHub](./_04-tp4/demo.png)</center>
...
<tr>
    <td colspan="2">
    🛑 HALTE !<br/>
    * Au plus tard le **7 mai à 17h59**, vous devez, à deux, vous **présenter en classe** et prendre 5 minutes pour montrer les étapes A, B et C à l'enseignant(e).
...
<table>
    ...
    <tr>
        <td>
            ...
            * Une branche créée et un merge par fonctionnalité du TP.
            * ⛔ Le français est évalué dans les messages des commits. Évitez les commits trop courts !
            * Les titres et les descriptions des commits sont présents, appropriés et clairs.
        </td>
        <td>
            <br/><br/>2 pts<br/>6 pts<br/>5 pts<br/>3 pts
        </td>
    </tr>
    <tr>
        <td>
...
<center>![Vue swagger](./_04-tp4/swagger.png)</center>
...
<center>![Routes](./_04-tp4/routes.png)</center>

### ♻ Composants réutilisables

<center>![Composants réutilisables](./_04-tp4/components.png)</center>
...
<Tabs>
    ...
    <center>![Composant réutilisable](./_04-tp4/accountmenu.png)</center>
    </TabItem>
    ...
    <center>![Composant réutilisable](./_04-tp4/commentbox.png)</center>
    </TabItem>
    <TabItem value="component6" label="LeftBar" default>
    Menu de gauche intégré dans le `HomeLayout`.
    <center>![Composant réutilisable](./_04-tp4/leftbar.png)</center>
    </TabItem>
    ...
    <center>![Composant réutilisable](./_04-tp4/posthumbnail.png)</center>
    </TabItem>
    ...
    <center>![Composant réutilisable](./_04-tp4/reply.png)</center>
    </TabItem>
</Tabs>

## 👽 Exception pour l'usage de l'IA

La génération de code par IA sera permise pour **un seul cas précis** dans ce devoir, **à condition d'indiquer que l'IA a été utilisée**.
...
Le code **situé après une requête** permettant de mettre à jour des **états** après une **requête HTTP** peut être généré par IA. Voici un exemple :
...
Aucun code **côté serveur** ne peut être généré par IA.
