...
* 📬 La remise est le **8 décembre à 23h59**.
...
<tr>
    ...
    <td>
        Étape C-🛴<br/><br/>
        Lorsqu’on crée un post, on doit être capable d’y joindre de zéro à plusieurs images.
    </td>
</tr>
<tr>
    <td colspan="2">
    🛑 HALTE !<br/>
    * Au plus tard le **26 novembre 12h pour le groupe de Maxime** ou le **27 novembre 17h pour le groupe de Mathieu**, vous devez, à deux, vous présenter en classe et prendre 5 minutes pour montrer les étapes A, B et C à l'enseignant(e).
...
<table>
    ...
    <tr>
        ...
        <td>
            <br/>1 pt<br/>3 pts<br/>5 pts<br/>1 pt
        </td>
    </tr>
    <tr>
