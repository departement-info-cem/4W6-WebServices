...
* Ceci concerne TOUTES les images qui ne sont pas des avatars ou des icônes de forum. (Donc ça inclut les images du message principal d'une publication !) Par contre, la potentielle image visible dans un `PostThumbnail` n'a pas à être cliquable. (Lorsqu'on consulte un **forum** ou la **page d'accueil**)
