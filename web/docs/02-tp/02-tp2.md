...
|Critère|Points|
|:-|:-|
|**⚙ Fonctionnement général**<br/>* 4 composants sont utilisés.<br/>* Les classes `Album`, `Artist` et `Show` existent et sont utilisées.<br/>* Les paramètres de route dynamique et les boutons de navigation sont fonctionnels.<br/>* Un hook a été utilisé pour la connexion à Spotify.<br/>* L'application est disponible en français et en anglais.|<br/>1 pt<br/>1 pt<br/>4 pts<br/>3 pts<br/>7 pts|
...
|**🎤 Page des concerts**<br/>* Titre avec nom de l'artiste en haut<br/>* Affichage des concerts (Date et heure localisés, pays et ville)<br/>* Requête à BandsInTown<br/>* Message spécial si aucun concert<br/>* Affichage de la carte Google avec marqueurs|<br/>0.666 pt<br/>4 pts<br/>4 pts<br/>1 pt<br/>5 pts|
